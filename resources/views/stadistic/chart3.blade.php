    ...
    <div class="container">
        <div class="row justify-content-center">
            <h2 class="justify-content-center">
                <span class="badge badge-light">Quejas por categoría y proveedor</span></h2> 
            <div class="col-md-12">
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#vendor").on('change', function() {
                ...
                if (vendor_id) {
                    $.ajax({
                        url: '/stadistic/getComplaintsByCategory/' + vendor_id,
                        type: 'GET',
                        dataType: 'json',
                        success: function(complaints) {
                            ...
                            for (let obj of Object.keys(complaints)) {
                                ...
                                myChart.data['labels'].push(datos.category)
